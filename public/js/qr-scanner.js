  ...
  if (result && content) {
    ...
    content.innerHTML = `
      <div style="display:flex;gap:20px;align-items:start;flex-wrap:wrap;">
        <img src="${v.imagen}" alt="${v.nombre}" style="width:120px;height:160px;object-fit:cover;border-radius:8px;">
        <div style="flex:1;min-width:200px;">
          <h4 style="margin-bottom:4px;">✅ ${v.nombre}</h4>
          ...
          <p style="margin-bottom:8px;">
            ...
            <span style="margin-left:8px;font-weight:700;color:var(--primary-dark);">$${v.precio_renta.toLocaleString()} / evento</span>
          </p>
          <p style="font-size:0.85rem;color:var(--text-secondary);margin-bottom:12px;">
            📏 ${v.talla.join(', ')} · 📦 ${v.disponibles} disponible${v.disponibles !== 1 ? 's' : ''}
          </p>
...
function actualizarEstadoDesdeScanner(id) {
  ...
  if (v) {
    ...
    showToast(`✅ "${v.nombre}" actualizado a: ${nuevoEstado}`, 'success');
